...
export default function UserDashboard() {
    ...
    const addAddress = async () => {
        try {
            ...
            if (!newAddress.fullName || !newAddress.street || !newAddress.postalCode || !newAddress.city || !newAddress.state || !newAddress.country || !newAddress.phone) {
                toast({
            ...
            // Postal Code validation (assuming 6 digits for India, or just generic numeric)
            const postalRegex = /^\d{6}$/;
            if (!postalRegex.test(newAddress.postalCode)) {
                toast({
                    title: "Validation Error",
