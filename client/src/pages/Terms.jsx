...
export default function Terms() {
  return (
    <>
      <SEOHelmet
        title="Terms & Conditions | Farbetter - Premium Protein Snacks"
        description="Read Farbetter's Terms & Conditions. Understand our policies regarding products, orders, shipping, and more."
        canonical="https://farbetter.com/terms"
      />
