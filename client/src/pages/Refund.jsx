...
export default function Refund() {
  return (
    <>
      <SEOHelmet
        title="Refund Policy | Farbetter - Premium Protein Snacks"
        description="Farbetter's Refund Policy. Learn about our returns, refunds, and exchange processes."
        canonical="https://farbetter.com/refund"
      />
